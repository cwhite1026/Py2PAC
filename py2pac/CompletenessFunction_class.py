	...
	def from_1d_array(cls, completeness_array, mag_range):
		...
		**Syntax**
		...
		completeness_function_1D : CompletenessFunction instance
		    An object that describeness completeness over the specified
		    magnitude range.
...
#----------------------------------------------------------------------
	...
	def query(self, mag_list, r_list=None):
		...
		**Syntax**
		...
		Returns
		-------
		completeness : 1D array of equal length to RA/Dec arrays
		    Completeness values corresponding to each RA/Dec pair in input.
